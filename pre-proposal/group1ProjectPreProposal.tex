...
\begin{document}
%-----------------------------------------------------------
\title{Chinese Checkers (preliminary title)}
...
producing strong programs that one day will be able to be the best
...
It provides a graphical interface and a network protocol. It appears
that we can make our own program connect to \emph{cheech} as a player
and thereby use the existing multiplayer functionality and graphics.
