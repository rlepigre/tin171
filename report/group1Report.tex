...
Checkers. Our goal was to create a program that could beat a novice
human player.
...
%% \subsection{Define an instance of the problem. How will you measure the performance of your program?}% Not in the report template
